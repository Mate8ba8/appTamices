...
app.layout = dbc.Container(
    [
        html.H1("Tabla de Tamizado", style=titulo_estilo),
        html.Img(src=f'data:image/jpeg;base64,{imagen_base64}'),
        
         dbc.Row(
            [   
                dbc.Col(
                    html.Div("Descripción de la tabla aquí"),
                    width=4,  # Ancho de la columna de descripción
                    style={'padding': '10px'}  # Espacio interior para la descripción
                ),
                ...
                dbc.Col(
                    dash_table.DataTable(
                        ...
                        style_table=tabla_estilo,  # Aplicar estilo a la tabla  
